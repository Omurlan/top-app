  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.title}>
        ...
        <Tag color="gray" size="m" aria-label={`${products.length}элементов`}>{products && products.length}</Tag>
      ...
      {firstCategory === TopLevelCategoryEnums.Courses && <HhData {...page.hh} />}
